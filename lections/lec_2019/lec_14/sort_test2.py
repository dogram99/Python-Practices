...
def test_sort_works_in_simple_cases():
    print("- sorts algorithm works in simple cases:", end=" ")
    passed = True
...
def test_sort_algorithm_stable():
    print("- sorts algorithm is stable:", end=" ")
    passed = True
    ...
    for A1 in ([[100] for i in range(5)],
        ...
        shuffle(A1)
        A2 = sorted(list(A1))  # here we are cheating: standard sorts is stable
        sort_algorithm(A1)
...
def test_sort_algorithm_is_universal():
    print("- sorts algorithm is universal:", end=" ")
    passed = True
...
def test_sort_algorithm_scalability(max_scale=100):
    print("- sorts algorithm on scale={0}:".format(max_scale), end=" ")
    passed = True
